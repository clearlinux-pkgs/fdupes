...
Version  : 2.4.0
Release  : 10
URL      : https://github.com/adrianlopezroche/fdupes/archive/v2.4.0/fdupes-2.4.0.tar.gz
Source0  : https://github.com/adrianlopezroche/fdupes/archive/v2.4.0/fdupes-2.4.0.tar.gz
...
%prep
%setup -q -n fdupes-2.4.0
cd %{_builddir}/fdupes-2.4.0
pushd ..
cp -a fdupes-2.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743428604
