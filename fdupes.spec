...
Version  : 2.1.2
Release  : 4
URL      : https://github.com/adrianlopezroche/fdupes/archive/v2.1.2/fdupes-2.1.2.tar.gz
Source0  : https://github.com/adrianlopezroche/fdupes/archive/v2.1.2/fdupes-2.1.2.tar.gz
...
%prep
%setup -q -n fdupes-2.1.2
cd %{_builddir}/fdupes-2.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644259585
